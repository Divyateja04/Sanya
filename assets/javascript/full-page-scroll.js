...
function gettimefunc(tilldate,id){
	...
	var x =setInterval(function() {
	  ...
	  document.getElementById(id).textContent = "This Opens in " + days + " Days " + hours + " Hours "
...
var countdown = gettimefunc("Sep 19,2021 00:00:00","texttimed");//Change Date in the format Month Date , Year HH:MM:SS